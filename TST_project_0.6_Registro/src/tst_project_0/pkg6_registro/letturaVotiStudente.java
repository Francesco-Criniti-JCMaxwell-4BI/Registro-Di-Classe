 ...
 * @author vladi
 */
public class letturaVotiStudente {
    public letturaVotiStudente() throws IOException{       
        int Max_val = 30;
        ...
        String user = formStudente.labelUser.getText();
            ...
            modelTst = (DefaultTableModel) formStudente.tabTst.getModel(); 
            modelMate = (DefaultTableModel) formStudente.tabMate.getModel(); 
            modelInfo = (DefaultTableModel) formStudente.tabInfo.getModel(); 
            modelIta = (DefaultTableModel) formStudente.tabIta.getModel();  
