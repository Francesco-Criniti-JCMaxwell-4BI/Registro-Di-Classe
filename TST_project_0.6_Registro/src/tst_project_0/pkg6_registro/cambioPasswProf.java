 ...
 * @author vladi
 */
public class cambioPasswProf {
    public cambioPasswProf(){
        String password = String.valueOf(formProfessore.passwC.getPassword());
         String passwordNew = String.valueOf(formProfessore.passwN.getPassword());
          String passwordNewConf = String.valueOf(formProfessore.passwNC.getPassword());
          String user = formProfessore.labelUser.getText();    
          String stpt;
